...
${OBJECTDIR}/Addition.o: Addition.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Addition.o Addition.c
...
${OBJECTDIR}/Dreiecksberechnung.o: Dreiecksberechnung.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Dreiecksberechnung.o Dreiecksberechnung.c

${OBJECTDIR}/Exponenten.o: Exponenten.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exponenten.o Exponenten.c
...
${OBJECTDIR}/Multiplikation.o: Multiplikation.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Multiplikation.o Multiplikation.c

${OBJECTDIR}/Subtraktion.o: Subtraktion.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Subtraktion.o Subtraktion.c

${OBJECTDIR}/Wurzeln.o: Wurzeln.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Wurzeln.o Wurzeln.c
